...
def insert_lilliefors(database_name="base.db"):
    ...
    params = [
        ...
        [['LiliefforsResult',], position, fk_id_function, 2, cursor, connection, fk_id_contributor], # en
        [['LiliefforsResultado',], position, fk_id_function, 3, cursor, connection, fk_id_contributor], # pt-br
    ]
    for param in params:
    ...
    params = [
        ...
        [['The sample size must be higher than or equal to 4, but it is', '$Number$', '!'],
        position, fk_id_function, 2, cursor, connection, fk_id_contributor], # en
        [['O tamanho amostral deve ser maior ou igual a 4, mas é', '$Number$', '!'],
