...
def lilliefors_fit(database_name):
    ...
    params = [
        ...
        [["The tabulated value for alpha", "{alfa}", "is not available. The available alpha values are:"], position, fk_id_function, 2, cursor, connection, fk_id_contributor], # en
        [['O valor tabelado para alfa', "{alfa}", "não está disponível. Os valores de alfa disponíveis são:"], position, fk_id_function, 3, cursor, connection, fk_id_contributor], # pt-br
    ]
    for param in params:
        func.insert_into_message_message_parts(*param)
    ###########################
    ...
    params = [
        ...
        [['Since p-value (', "{p_value}", ") >= alpha (", "{alfa}", "), we have NO evidence to reject the hypothesis of data normality, according to the Lilliefors test at a", "{100*(1-alfa)}", "% of confidence level."], position, fk_id_function, 2, cursor, connection, fk_id_contributor], # en
        [['Como o p-valor (', "{p_value}", ") >= alfa (", "{alfa}", "), nós NÃO temos evidências para rejeitar a hipótese de normalidade dos dados, de acordo com o teste de Lilliefors com", "{100*(1-alfa)}", "% de confiança."], position, fk_id_function, 3, cursor, connection, fk_id_contributor], # pt-br
    ]
    for param in params:
        func.insert_into_message_message_parts(*param)
    ###########################
    ...
    params = [
        [['Text', "{p_value}", "Text", "{alfa}", "Text", "{100*(1-alfa)}", "Text"], position, fk_id_function, 1, cursor, connection, fk_id_contributor], # univ
        [['Since p-value (', "{p_value}", ") < alpha (", "{alfa}", "), we HAVE evidence to reject the hypothesis of data normality, according to the Lilliefors test at a", "{100*(1-alfa)}", "% of confidence level."], position, fk_id_function, 2, cursor, connection, fk_id_contributor], # en
        [['Como o p-valor (', "{p_value}", ") < alfa (", "{alfa}", "), nós TEMOS evidências para rejeitar a hipótese de normalidade dos dados, de acordo com o teste de Lilliefors com", "{100*(1-alfa)}", "% de confiança."], position, fk_id_function, 3, cursor, connection, fk_id_contributor], # pt-br
    ]
    for param in params:
        func.insert_into_message_message_parts(*param)
    ###########################
    ...
    params = [
        ...
        [['Since the tabulated value (', "{tabulated}", ") >= statistic (", "{statistic}", "), we have NO evidence to reject the hypothesis of data normality, according to the Lilliefors test at a", "{100*(1-alfa)}", "% of confidence level."], position, fk_id_function, 2, cursor, connection, fk_id_contributor], # en
        [['Como o valor tabelado (', "{p_value}", ") >= estatística (", "{statistic}", "), nós NÃO temos evidências para rejeitar a hipótese de normalidade dos dados, de acordo com o teste de Lilliefors com", "{100*(1-alfa)}", "% de confiança."], position, fk_id_function, 3, cursor, connection, fk_id_contributor], # pt-br
    ]
    for param in params:
        func.insert_into_message_message_parts(*param)
    ...
    params = [
        [['Text', "{tabulated}", "Text", "{statistic}", "Text", "{100*(1-alfa)}", "Text"], position, fk_id_function, 1, cursor, connection, fk_id_contributor], # univ
        [['Since the tabulated value (', "{tabulated}", ") < statistic (", "{statistic}", "), we HAVE evidence to reject the hypothesis of data normality, according to the Lilliefors test at a", "{100*(1-alfa)}", "% of confidence level."], position, fk_id_function, 2, cursor, connection, fk_id_contributor], # en
        [['Como o valor tabelado (', "{tabulated}", ") < estatística (", "{statistic}", "), nós TEMOS evidências para rejeitar a hipótese de normalidade dos dados, de acordo com o teste de Lilliefors com", "{100*(1-alfa)}", "% de confiança."], position, fk_id_function, 3, cursor, connection, fk_id_contributor], # pt-br
    ]
    for param in params:
        func.insert_into_message_message_parts(*param)
    ...
    params = [
        [['Text'], position, fk_id_function, 1, cursor, connection, fk_id_contributor], # univ
        [["LillieforsResult"], position, fk_id_function, 2, cursor, connection, fk_id_contributor], # en
        [["ResultadoLilliefors"], position, fk_id_function, 3, cursor, connection, fk_id_contributor], # pt-br
    ]
    for param in params:
        func.insert_into_message_message_parts(*param)
