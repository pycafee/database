...
def normalitycheck_fit(database_name):
    ...
    params = [
        [['Text', "{critical}", "Text", "{statistic}", "Text", "{test_name}", "Text", "{100*(1-alfa)}", "Text"], position, fk_id_function, 1, cursor, connection, fk_id_contributor], # univ
        [['Since the critical value (', "{critical}", ") >= statistic (", "{statistic}", "), we have NO evidence to reject the hypothesis of data normality, according to the", "{test_name}", "test at a", "{100*(1-alfa)}", "% of confidence level."], position, fk_id_function, 2, cursor, connection, fk_id_contributor], # en
        [['Como o valor crítico (', "{critical}", ") >= estatística (", "{statistic}", "), nós NÃO temos evidências para rejeitar a hipótese de normalidade dos dados, de acordo com o teste de", "{test_name}", "com", "{100*(1-alfa)}", "% de confiança."], position, fk_id_function, 3, cursor, connection, fk_id_contributor], # pt-br
    ]
    for param in params:
        func.insert_into_message_message_parts(*param)
    ###########################
    ...
    params = [
        [['Text', "{critical}", "Text", "{statistic}", "Text", "{test_name}", "Text", "{100*(1-alfa)}", "Text"], position, fk_id_function, 1, cursor, connection, fk_id_contributor], # univ
        [['Since the critical value (', "{critical}", ") < statistic (", "{statistic}", "), we HAVE evidence to reject the hypothesis of data normality, according to the", "{test_name}", "test at a", "{100*(1-alfa)}", "% of confidence level."], position, fk_id_function, 2, cursor, connection, fk_id_contributor], # en
        [['Como o valor crítico (', "{critical}", ") < estatística (", "{statistic}", "), nós TEMOS evidências para rejeitar a hipótese de normalidade dos dados, de acordo com o teste de", "{test_name}", "com", "{100*(1-alfa)}", "% de confiança."], position, fk_id_function, 3, cursor, connection, fk_id_contributor], # pt-br
    ]
    for param in params:
        func.insert_into_message_message_parts(*param)
    ###########################
    ...
    params = [
        ...
        [['Since p-value (', "{p_value}", ") >= alpha (", "{alfa}", "), we have NO evidence to reject the hypothesis of data normality, according to the", "{test_name}", "test at a", "{100*(1-alfa)}", "% of confidence level."], position, fk_id_function, 2, cursor, connection, fk_id_contributor], # en
        [['Como o p-valor (', "{p_value}", ") >= alfa (", "{alfa}", "), nós NÃO temos evidências para rejeitar a hipótese de normalidade dos dados, de acordo com o teste de", "{test_name}", "com", "{100*(1-alfa)}", "% de confiança."], position, fk_id_function, 3, cursor, connection, fk_id_contributor], # pt-br
    ]
    for param in params:
        func.insert_into_message_message_parts(*param)
    ###########################
    ...
    params = [
        [['Text', "{p_value}", "Text", "{alfa}", "Text", "{100*(1-alfa)}", "Text"], position, fk_id_function, 1, cursor, connection, fk_id_contributor], # univ
        [['Since p-value (', "{p_value}", ") < alpha (", "{alfa}", "), we HAVE evidence to reject the hypothesis of data normality, according to the", "{test_name}", "test at a", "{100*(1-alfa)}", "% of confidence level."], position, fk_id_function, 2, cursor, connection, fk_id_contributor], # en
        [['Como o p-valor (', "{p_value}", ") < alfa (", "{alfa}", "), nós TEMOS evidências para rejeitar a hipótese de normalidade dos dados, de acordo com o teste de", "{test_name}", "com", "{100*(1-alfa)}", "% de confiança."], position, fk_id_function, 3, cursor, connection, fk_id_contributor], # pt-br
    ]
    for param in params:
        func.insert_into_message_message_parts(*param)
    ###########################
